export const pdfDocs: Record<string, { url: string, name: string, title?: string, size?: number }> = {
  "p4450.pdf": {
    url: "/pdfs/p4450.pdf",
    name: "p4450.pdf",
    title: "IRS Congressional Budget Justification & Annual Performance Report and Plan Fiscal Year 2024",
    size: 2741941
  },
