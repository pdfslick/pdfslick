<script lang="ts">
	...
	onMount(async () => {
		 ...
		 */
		pdfSlick.loadDocument(url).then(() => (pdfSlick.viewer.currentScaleValue = 'page-fit'));
		...
		<div class="flex justify-center">
			...
			>
				<button
					...
					id="previousBtn"
					type="button"
					class="relative inline-flex items-center rounded-l px-2 py-2 text-neutral-500 ring-0 ring-inset ring-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900 enabled:hover:text-neutral-900 dark:enabled:hover:text-neutral-50 transition-all focus:z-10 disabled:opacity-70 pointer-events-auto"
				>
				...
				<button
					...
					id="zoomOutBtn"
					type="button"
					class="relative inline-flex items-center px-2 py-2 text-neutral-500 ring-0 ring-inset ring-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900 enabled:hover:text-neutral-900 dark:enabled:hover:text-neutral-50 transition-all focus:z-10 pointer-events-auto disabled:opacity-70"
				>
				...
				<button
					...
					id="nextBtn"
					type="button"
					class="relative inline-flex items-center rounded-r px-2 py-2 text-neutral-500 ring-0 ring-inset ring-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-900 enabled:hover:text-neutral-900 dark:enabled:hover:text-neutral-50 transition-all focus:z-10 disabled:opacity-70 pointer-events-auto"
				>
...
<style lang="postcss">
	:global(body) {
		background-color: color-mix(in srgb, Canvas, CanvasText 25%);
		color: CanvasText;
		color-scheme: light dark;
	}

	.tools {
		background-color: Canvas; /*color-mix(in srgb, Canvas, CanvasText 15%);*/
	}
</style>
